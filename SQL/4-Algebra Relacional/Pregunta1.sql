...
-- NOTE: Doneu una seqüència d'operacions d'algebra relacional per obtenir el nom del departament on treballa i 
-- el nom del projecte on està assignat l'empleat número 2.
